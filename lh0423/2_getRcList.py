...
df = df[(((df['人气排名'] < 350) & (df['人气较昨日变动'] > 1000)) | ((df['人气排名'] < 150) & (df['人气较昨日变动'] > 450)) | ((df['人气排名'] < 50) & (df['人气较昨日变动'] > 150)))]
...
if df is not None and not df.empty:
    ...
    sorted_df = df_all.sort_values(by='人气排名', ascending=True)
    ...
    model.output_file(sorted_df, '飙升个股信息(今日人气飙升前100+排名350升1000/150升450/50升150)')
