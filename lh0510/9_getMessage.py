...
headers = {
    ...
    "sec-ch-ua-mobile": "?0",
    "Authorization": "eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6InBjOjIxODc3Nzo5MTAwOWZiOC0xZTM0LTRkOWUtOTIxOS0zMzBiYzU1NDFmMjkifQ.SJ96MXafigCtYjeGcqE00fWEULPloGIYIuW2cE7glHRY_6b2kuapFffwKT5dQCcesAh3qfCOYr9YIvRHgLbK_A",
...
def get_messages():
    ...
    response = requests.get("http://111.170.164.89:600/ticailishi?page=1&pageSize=40", headers=headers2)
...
def get_subjects(subject_id):
    ...
    response = requests.get(f"http://111.170.164.89:600/ticaitupu?id={subject_id}", headers=headers2)
    if response.status_code == 200:
        data = response.json()
