...
if not df.empty:
    ...
    if not rc_df.empty:
        ...
        model.output_file(sorted_df_F,'热榜个股信息1(热榜350内+最近热榜飙升超1000+支撑线<15%)')
        print(model.beautify(sorted_df_T))
        model.output_file(sorted_df_T,'热榜个股信息2',0)
        ...
        model.output_file(sorted_df2,'热榜个股信息3（热榜个股信息1热榜350内+最近热榜飙升超1000+涨停+压力线超5%)')
    ...
    if not limitup_df.empty:
        ...
        model.output_file(limitup_df,'热榜个股信息4(热榜350内+涨停+支撑线<20%)')
'''
